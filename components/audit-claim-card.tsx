                    ...
                    >
                      <div className="mt-3 bg-[#08080b] rounded-lg border border-cv-border/80 overflow-hidden">
                        ...
                        {claim.transactionHash && (() => {
                          ...
                          const sub =
                            isSuccess
                              ? 'Receipt status: success — Solana mainnet'
                              : isRevert
                                ? 'Receipt status: reverted — matches dApp "Transaction failed" when shown'
                                : isTimeout
                                  ? 'Could not confirm in time — check Solscan for final status'
                                  : 'Receipt status not recorded (older scan) — verify on Solscan';
                          ...
                          <div className="px-5 py-4 border-b border-cv-border/60">
                            ...
                            <div className="flex items-center gap-3 flex-wrap">
                              ...
                              <a
                                href={claim.transactionExplorerUrl ?? `https://solscan.io/tx/${claim.transactionHash}`}
                                target="_blank"
                        ...
                        {/* Tx attempted but not broadcast (e.g. insufficient SOL for fees) */}
                        {!claim.transactionHash && claim.transactionAttempted && (
                          <div className="px-5 py-4 border-b border-cv-border/60">
                            ...
                            <p className="text-[11px] font-mono text-zinc-500 mb-2">
                              ...
                              Not broadcast (likely insufficient SOL for transaction fees).
                            </p>
                            {claim.walletAddress && (
                              <div className="flex items-center gap-3 flex-wrap">
                                <span className="text-[10px] font-mono text-zinc-600 bg-cv-elevated px-2 py-1 rounded truncate max-w-[260px]">
                                ...
                                <a
                                  href={`https://solscan.io/account/${claim.walletAddress}`}
                                  target="_blank"
                                  rel="noopener noreferrer"
