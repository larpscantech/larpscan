...
//  - Only lowercase paths (real routes are lowercase; "URLs", "SOL" etc. are not)
    ...
    if (steps.length === 0) {
      ...
      if (isCreationFeature) {
        ...
        const candidateCreatePaths = [
          ...
          '/en/create-token',  // common default locale for sites like pump.fun
          '/create-token',
          '/create',
          '/launch',
...
3. Find the trade form: an amount input (SOL, ETH, amount, "you pay") and a "Buy" or "Swap" button.
