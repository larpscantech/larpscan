 ...
 *
 * Run: TEST_BASE_URL=http://localhost:3002 TEST_URL=https://pump.fun/ node test-verify.mjs
 * Run with CA: TEST_BASE_URL=http://localhost:3002 TEST_CA=YourSolanaMint... node test-verify.mjs
 *
 * Strategy:
...
const CA       = process.env.TEST_CA  ?? 'So11111111111111111111111111111111111111112';
